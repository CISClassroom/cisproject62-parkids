...
mysqli_set_charset($connect,"utf8");
 $tab_query = "SELECT * FROM payment ORDER BY pay_id ASC";
 $tab_result = mysqli_query($connect, $tab_query);
 $tab_menu = '';
 $tab_content = '';
 $product_query = "SELECT * FROM payment where pay_full = '$user' ORDER BY pay_id ASC";
 ...
 while($sub_row = mysqli_fetch_array($product_result))
 {
  ...
  <div class="col-md-3" style="margin-bottom:36px;">
   ...
   <h4>ชื่อ-นามสกุล : '.$sub_row["pay_full"].'</h4>
   <h4>ธนาคาร : '.$sub_row["pay_bank"].'</h4>
   <h4>จำนวนเงิน : '.$sub_row["pay_amount"].' บาท</h4>
   <h4>วันที่โอน : '.$sub_row["pay_date"].'</h4>
   <h4>เวลาที่โอน : '.$sub_row["pay_time"].'</h4>
...
<html lang="en">
   <head>
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
            ...
            <title> รายการที่ชำระทั้งหมด </title>
...
<div class="top">
    ...
    if (isset($_SESSION['member_id'])){
     ...
     ?>
      ...
      <br>
                <h2><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; รายการที่ชำระทั้งหมด</h2></b><br>
