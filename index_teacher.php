...
function showDivs(n) {
  ...
  x[slideIndex-1].style.display = "block";  
    ...
    <div class="menu"> <br>
        <a href="FormTeacher.php" class="w3-btn  "><h4> สมัครเป็นติวเตอร์ </h4></a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        <a href="information student_tutor.php" class="w3-btn "><h4> ข้อมูลผู้เรียน </h4></a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        <a href="Paymentlist_tutor.php" class="w3-btn "><h4> รายได้ของฉัน </h4></a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
