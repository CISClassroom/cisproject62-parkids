...
$tab_content = '';
 ...
 while($sub_row = mysqli_fetch_array($product_result))
 {
  ...
  <a href="profile_tutor.php?tutor_id='.$sub_row["tutor_id"].'"><img src="images/'.$sub_row["image"].'" class="img-responsive img-thumbnail" style="width:200px; height:200px;"/>
   ...
   <button> <a href="FormStudent.php?tutor_id='.$sub_row["tutor_id"].'"><h4> สมัครเรียน </h4></a></button>
...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    ...
    <title>Home : ผู้เรียนผู้ปกครอง</title>
...
<body onload="myFunction()">
        ...
        if (isset($_SESSION['member_id'])){
          echo "<h4><a href='profile.php?member_id=" . $_SESSION["member_id"] ."'>".$_SESSION['member_username'];
            echo "<h4>" ;
            echo "<label><a href='logout.php'>ออกจากระบบ</a></label> ";
          }
          else{
...
function showDivs(n) {
  ...
  x[slideIndex-1].style.display = "block";  
    ...
    <div class="menu"> <br>
        ...
        <a href="information tutor_student.php" class="w3-btn "><h4> ข้อมูลวิชาที่สมัครเรียน </h4></a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        <a href="payment.php" class="w3-btn "><h4> แจ้งชำระค่าใช้จ่าย </h4></a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
