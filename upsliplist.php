...
$tab_menu = '';
$tab_content = '';
 $product_query = "SELECT * FROM upslip WHERE upslip_id ";
...
<html lang="en">
   <head>
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
            ...
            <title> รายการชำระเงินทั้งหมด </title>
...
<div class="mean">
<h4> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="upslip.php">กลับไปยังหน้าหลัก </a></h4>
...
<div class="top">
    ...
    if (isset($_SESSION['member_id'])){
     ...
     ?>
      ...
      <br>
                <h2><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; รายการชำระทั้งหมด</h2></b><br>
